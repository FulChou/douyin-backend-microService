...
func NewServiceInfo() *kitex.ServiceInfo {
	...
	handlerType := (*vediodemo.VideoService)(nil)
...
func feedHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		st := s.Stream
		req := new(vediodemo.FeedRequest)
		if err := st.RecvMsg(req); err != nil {
			return err
		}
		resp, err := handler.(vediodemo.VideoService).Feed(ctx, req)
		if err != nil {
			return err
		}
	...
	case *FeedArgs:
		success, err := handler.(vediodemo.VideoService).Feed(ctx, s.Req)
		if err != nil {
			return err
		}
...
var FeedArgs_Req_DEFAULT *vediodemo.FeedRequest

func (p *FeedArgs) GetReq() *vediodemo.FeedRequest {
	if !p.IsSetReq() {
...
type FeedResult struct {
	Success *vediodemo.FeedResponse
}

var FeedResult_Success_DEFAULT *vediodemo.FeedResponse

func (p *FeedResult) FastRead(buf []byte, _type int8, number int32) (n int, err error) {
	if !p.IsSetSuccess() {
		p.Success = new(vediodemo.FeedResponse)
	}
...
func (p *FeedResult) Unmarshal(in []byte) error {
	msg := new(vediodemo.FeedResponse)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
	p.Success = msg
...
func (p *FeedResult) GetSuccess() *vediodemo.FeedResponse {
	if !p.IsSetSuccess() {
...
func (p *FeedResult) SetSuccess(x interface{}) {
	p.Success = x.(*vediodemo.FeedResponse)
}
...
func publishHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		st := s.Stream
		req := new(vediodemo.PublishRequest)
		if err := st.RecvMsg(req); err != nil {
			return err
		}
		resp, err := handler.(vediodemo.VideoService).Publish(ctx, req)
		if err != nil {
			return err
		}
		if err := st.SendMsg(resp); err != nil {
	...
	case *PublishArgs:
		success, err := handler.(vediodemo.VideoService).Publish(ctx, s.Req)
		if err != nil {
			return err
		}
...
func (p *PublishArgs) Unmarshal(in []byte) error {
	msg := new(vediodemo.PublishRequest)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
	p.Req = msg
...
var PublishArgs_Req_DEFAULT *vediodemo.PublishRequest

func (p *PublishArgs) GetReq() *vediodemo.PublishRequest {
	if !p.IsSetReq() {
...
type PublishResult struct {
	Success *vediodemo.PublishResponse
}

var PublishResult_Success_DEFAULT *vediodemo.PublishResponse

func (p *PublishResult) FastRead(buf []byte, _type int8, number int32) (n int, err error) {
	if !p.IsSetSuccess() {
		p.Success = new(vediodemo.PublishResponse)
	}
	return p.Success.FastRead(buf, _type, number)
}
...
func (p *PublishResult) Unmarshal(in []byte) error {
	msg := new(vediodemo.PublishResponse)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
	p.Success = msg
...
func (p *PublishResult) GetSuccess() *vediodemo.PublishResponse {
	if !p.IsSetSuccess() {
...
func (p *PublishResult) SetSuccess(x interface{}) {
	p.Success = x.(*vediodemo.PublishResponse)
}
...
func publishListHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		st := s.Stream
		req := new(vediodemo.PublishListRequest)
		if err := st.RecvMsg(req); err != nil {
			return err
		}
		resp, err := handler.(vediodemo.VideoService).PublishList(ctx, req)
		if err != nil {
			return err
		}
		if err := st.SendMsg(resp); err != nil {
	...
	case *PublishListArgs:
		success, err := handler.(vediodemo.VideoService).PublishList(ctx, s.Req)
		if err != nil {
			return err
		}
...
func (p *PublishListArgs) Unmarshal(in []byte) error {
	msg := new(vediodemo.PublishListRequest)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
	p.Req = msg
...
var PublishListArgs_Req_DEFAULT *vediodemo.PublishListRequest

func (p *PublishListArgs) GetReq() *vediodemo.PublishListRequest {
	if !p.IsSetReq() {
...
type PublishListResult struct {
	Success *vediodemo.PublishListResponse
}

var PublishListResult_Success_DEFAULT *vediodemo.PublishListResponse

func (p *PublishListResult) FastRead(buf []byte, _type int8, number int32) (n int, err error) {
	if !p.IsSetSuccess() {
		p.Success = new(vediodemo.PublishListResponse)
	}
	return p.Success.FastRead(buf, _type, number)
}
...
func (p *PublishListResult) Unmarshal(in []byte) error {
	msg := new(vediodemo.PublishListResponse)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
	p.Success = msg
...
func (p *PublishListResult) GetSuccess() *vediodemo.PublishListResponse {
	if !p.IsSetSuccess() {
...
func (p *PublishListResult) SetSuccess(x interface{}) {
	p.Success = x.(*vediodemo.PublishListResponse)
}
...
func (p *kClient) Feed(ctx context.Context, Req *vediodemo.FeedRequest) (r *vediodemo.FeedResponse, err error) {
	var _args FeedArgs
	_args.Req = Req
...
func (p *kClient) Publish(ctx context.Context, Req *vediodemo.PublishRequest) (r *vediodemo.PublishResponse, err error) {
...
func (p *kClient) PublishList(ctx context.Context, Req *vediodemo.PublishListRequest) (r *vediodemo.PublishListResponse, err error) {
